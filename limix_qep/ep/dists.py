...
class Joint(object):
    ...
    # def update(self, m, sigg2, S, Q, L1, teta, A1, diagK, SQt, K=None):
    #
    ...
    # K is provided if low-rank stuff does not make sense
    def update(self, m, S, Q, L, teta, A1, diagK, SQt, QSQt=None):

        L1_Qt = cho_solve(L, Q.T) # !!!CUBIC!!!
