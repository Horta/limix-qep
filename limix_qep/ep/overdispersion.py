...
from .util import shall_use_low_rank_tricks
from .predictor import BernoulliPredictor
from .predictor import BinomialPredictor
...
class OverdispersionEP(Cached):
    def __init__(self, y, M, Q, S, QSQt=None, outcome_type=None):
    ...
    def K(self):
        ...
        sigg2 = self._sigg2
        delta = self._delta
        return sum2diag(sigg2 * dot(Q, SQt), sigg2 * delta)
